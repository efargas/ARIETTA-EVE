...
The ARIETTA G25 boards from ACME SYSTEMS (http://www.acmesystems.it) are based on ATMEL AT91SAM9G25 processors running Linux.
...
The ARIETTA is combined with a small daughter board <img src="EVE.jpg"> built by myself implementing an USB port, housing the WiFi module for better radio performance and includes an audio codec with headphone plug.
